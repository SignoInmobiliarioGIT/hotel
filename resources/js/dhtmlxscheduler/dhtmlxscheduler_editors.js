...
Scheduler.plugin(function (e) {
    e.form_blocks.combo = {
        ...
        set_value: function (t, a, i, n) {
            ...
            }(), window.dhx_globalImgPath = n.image_path || "/",
        ...
        render: function (t) {
            ...
            for (var i = 0; i < t.options.length; i++) {
                var n = e.uid();
                a += "<input id='" + n + "' type='radio' name='" + t.name + "' value='" + t.options[i].key + "'><label for='" + n + "'> " + t.options[i].label + "</label>", t.vertical && (a += "<br/>")
            }
            return a += "</div>"
        },
        ...
        set_value: function (t, a, i, n) {
            ...
            if (e.config.wide_form ? (t.innerHTML = d, t.nextSibling.innerHTML = s) : t.innerHTML = s + d, n.handler) {
                t.getElementsByTagName("input")[0].onclick = n.handler
            }
        },
        get_value: function (e, t, a) {
