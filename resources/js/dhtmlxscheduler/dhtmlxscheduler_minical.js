    ...
    e.templates.calendar_month = e.date.date_to_str("%F %Y"), e.templates.calendar_scale_date = e.date.date_to_str("%D"), e.templates.calendar_date = e.date.date_to_str("%d"), e.config.minicalendar = {
            ...
            if ("string" == typeof r && (r = this.templates.api_date(r)), a) i = this._render_calendar(a.parentNode, r, t, a), e.unmarkCalendar(i);
                ...
                if ("string" == typeof o && (o = document.getElementById(o)), "string" == typeof d && (d = document.getElementById(d)), d && void 0 === d.left) {
                    var s = e.$domHelpers.getOffset(d);
                    d = {
                        top: s.top + d.offsetHeight,
                        left: s.left
                    }
                }
                o || (o = e._get_def_cont(d)), i = this._render_calendar(o, r, t), i.onclick = function (t) {
                    ...
                    var a = t.target || t.srcElement,
                        n = e.$domHelpers;
                    if (n.closest(a, ".dhx_month_head") && !n.closest(a, ".dhx_after") && !n.closest(a, ".dhx_before")) {
                        var i = n.closest(a, "[data-cell-date]"),
                            r = i.getAttribute("data-cell-date"),
                            o = e.templates.parse_date(r);
                        e.unmarkCalendar(this), e.markCalendar(this, o, "dhx_calendar_click"), this._last_date = o, this.conf.handler && this.conf.handler.call(e, o, this)
                    }
                }
            }
        ...
        e._get_def_cont = function (e) {
            ...
            for (var a = t || 250, n = 0, i = document.createElement("div"), r = this.date.week_start(e._currentDate()), o = 0; o < 7; o++) this._cols[o] = Math.floor(a / (7 - o)), this._render_x_header(o, n, r, i), r = this.date.add(r, 1, "day"), a -= this._cols[o], n += this._cols[o];
        ...
        e._render_calendar = function (t, a, n, i) {
            ...
            var g, f = this._week_template(t.offsetWidth - 1 - this.config.minicalendar.padding);
            i ? g = i : (g = document.createElement("div"),
                g.className = "dhx_cal_container dhx_mini_calendar"), g.setAttribute("date", this._helpers.formatDate(a)), g.innerHTML = "<div class='dhx_year_month'></div><div class='dhx_year_grid" + (e.config.rtl ? " dhx_grid_rtl'>" : "'>") + "<div class='dhx_year_week'>" + (f ? f.innerHTML : "") + "</div><div class='dhx_year_body'></div></div>";
            var v = g.querySelector(".dhx_year_month"),
                m = g.querySelector(".dhx_year_week"),
                p = g.querySelector(".dhx_year_body");
            if (v.innerHTML = this.templates.calendar_month(a),
                n.navigation)
                for (var y = function (t, a) {
                        ...
                        return function () {
                            if (n.sync)
                                for (var a = e._synced_minicalendars, i = 0; i < a.length; i++) y(a[i], t);
                            else e.config.rtl && (t = -t), y(g, t)
                        }
                    }, D = [e.locale.labels.prev, e.locale.labels.next], E = 0; E < 2; E++) {
                    var N = document.createElement("div");
                    N.className = b[E], e._waiAria.headerButtonsAttributes(N, D[E]), N.style.cssText = x[E], N.innerHTML = this._mini_cal_arrows[E], v.appendChild(N), N.onclick = k(w[E])
                }
            g._date = new Date(a), g.week_start = (a.getDay() - (this.config.start_on_monday ? 1 : 0) + 7) % 7;
            var S = g._min_date = this.date.week_start(a);
            g._max_date = this.date.add(g._min_date, 6, "week"), this._reset_month_scale(p, a, S, 6), i || t.appendChild(g),
                m.style.height = m.childNodes[0].offsetHeight - 1 + "px";
            var M = e.uid();
            e._waiAria.minicalHeader(v, M), e._waiAria.minicalGrid(g.querySelector(".dhx_year_grid"), M), e._waiAria.minicalRow(m);
            ...
            return e._waiAria.minicalHeader(v, M), this._cols = o, this._mode = d, this._colsS = s,
            ...
            render: function (t) {
                ...
                for (var d = o; d < r; d += 1 * this.config.time_step) {
                    a += "<option value='" + d + "'>" + this.templates.time_picker(i) + "</option>", t._time_values.push(d), i = this.date.add(i, this.config.time_step, "minute")
                }
                a += "</select>";
                e.config.full_day;
            ...
            set_value: function (t, a, n, i) {
                function r(t, a, n) {
                    c(t, a, n), t.value = e.templates.calendar_time(a), t._date = e.date.date_part(new Date(a))
                }
                ...
                var d, s, _ = t.getElementsByTagName("input"),
                ...
                if (e.config.full_day) {
                    ...
                    var u = t.previousSibling.getElementsByTagName("input")[0],
                        g = 0 === e.date.time_part(n.start_date) && 0 === e.date.time_part(n.end_date);
                    u.checked = g, l[0].disabled = u.checked, l[1].disabled = u.checked, u.onclick = function () {
                        ...
                        var i = d || n.start_date,
                            o = s || n.end_date;
                        r(_[0], i), r(_[1], o), l[0].value = 60 * i.getHours() + i.getMinutes(), l[1].value = 60 * o.getHours() + o.getMinutes(), l[0].disabled = u.checked, l[1].disabled = u.checked
                    }
                }
            ...
            e.attachEvent("onViewChange", n), e.attachEvent("onXLE", n),
            ...
            if (!({
                    ...
                    agenda: !0,
                    grid: !0
                } [r] || n.valueOf() <= o.valueOf() && i.valueOf() >= d.valueOf()))
                for (var s = n; s.valueOf() < i.valueOf();) o.valueOf() <= s.valueOf() && d > s && e.markCalendar(t, s, "dhx_calendar_click"), s = e.date.add(s, 1, "day")
        },
